...
function car_demon_service_form($location, $popup_id = '', $popup_button='') {
	...
	if (isset($car_demon_options['use_form_css'])) {
		if ($car_demon_options['use_form_css'] != 'No') {
			wp_enqueue_style('car-demon-service-form-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-service-form.css', array(), CAR_DEMON_VER);
		}
	} else {
		wp_enqueue_style('car-demon-service-form-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-service-form.css', array(), CAR_DEMON_VER);
	}
	wp_enqueue_style('car-demon-service-calendar-css', plugins_url() . '/car-demon/theme-files/css/CalendarControl.css', array(), CAR_DEMON_VER);
	...
	if (!empty($popup_id)) {
		...
		wp_enqueue_script('car-demon-service-request-popup-js', plugins_url() . '/car-demon/car-demon-forms/forms/js/car-demon-service-request-popup.js', array(), CAR_DEMON_VER);
		if (isset($car_demon_options['use_form_css'])) {
			if ($car_demon_options['use_form_css'] != 'No') {
				wp_enqueue_style('car-demon-service-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-service-request-popup.css', array(), CAR_DEMON_VER);
			}
		} else {
			wp_enqueue_style('car-demon-service-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-service-request-popup.css', array(), CAR_DEMON_VER);
		}
	...
	$x .='
			...
			$x = apply_filters('cd_form_filter', $x, 'service_appointment', '');
			$x = apply_filters('car_demon_mail_hook_form', $x, 'service_appointment', 'unk'); //= deprecated
