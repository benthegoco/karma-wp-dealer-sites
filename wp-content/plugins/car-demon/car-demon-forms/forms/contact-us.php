...
function car_demon_contact_request($send_to, $popup_id = '', $popup_button='') {
	...
	if (!empty($popup_id)) {
		...
		wp_enqueue_script('car-demon-contact-us-popup-js', plugins_url() . '/car-demon/car-demon-forms/forms/js/car-demon-contact-us-popup.js', array(), CAR_DEMON_VER);
		if (isset($car_demon_options['use_form_css'])) {
			if ($car_demon_options['use_form_css'] != 'No') {
				wp_enqueue_style('car-demon-contact-us-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-contact-us-popup.css', array(), CAR_DEMON_VER);
			}
		} else {
			wp_enqueue_style('car-demon-contact-us-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-contact-us.css', array(), CAR_DEMON_VER);
		}
		...
		if (isset($car_demon_options['use_form_css'])) {
			if ($car_demon_options['use_form_css'] != 'No') {
				wp_enqueue_style('car-demon-contact-us-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-contact-us.css', array(), CAR_DEMON_VER);
			}
		} else {
			wp_enqueue_style('car-demon-contact-us-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-contact-us.css', array(), CAR_DEMON_VER);
		}
	...
	$x = apply_filters('cd_form_filter', $x, 'contact_us', '');
	$x = apply_filters('car_demon_mail_hook_form', $x, 'contact_us', 'unk'); // deprecated
	$x .= '
...
function contact_locations_radio() {
	...
	$html = '
		...
		<legend>' . __( 'Send To', 'car-demon' ) . '</legend>
		<ol class="cd-ol">
			<li id="select_location" class="cd-box-title">' . __( 'Select who you would like to send your message to', 'car-demon' ) . '</li>
