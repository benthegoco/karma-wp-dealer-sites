...
function car_demon_part_request($location, $popup_id = '', $popup_button='') {
	...
	if (!empty($popup_id)) {
		...
		wp_enqueue_script('car-demon-part-request-popup-js', plugins_url() . '/car-demon/car-demon-forms/forms/js/car-demon-part-request-popup.js', array(), CAR_DEMON_VER);
		if (isset($car_demon_options['use_form_css'])) {
			if ($car_demon_options['use_form_css'] != 'No') {
				wp_enqueue_style('car-demon-part-request-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-part-request-popup.css', array(), CAR_DEMON_VER);
			}
		} else {
			wp_enqueue_style('car-demon-part-request-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-part-request-popup.css', array(), CAR_DEMON_VER);
		}
	...
	if (isset($car_demon_options['use_form_css'])) {
		if ($car_demon_options['use_form_css'] != 'No') {
			wp_enqueue_style('car-demon-part-request-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-part-request.css', array(), CAR_DEMON_VER);
		}
	} else {
		wp_enqueue_style('car-demon-part-request-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-part-request.css', array(), CAR_DEMON_VER);
	}
	...
	$x .='
			...
			$x = apply_filters('cd_form_filter', $x, 'parts', '');
			$x = apply_filters('car_demon_mail_hook_form', $x, 'parts', 'unk'); //= deprecated
