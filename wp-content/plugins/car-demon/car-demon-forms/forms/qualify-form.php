...
function car_demon_qualify_form($location, $popup_id, $popup_button) {
	...
	if (isset($car_demon_options['use_form_css'])) {
		if ($car_demon_options['use_form_css'] != 'No') {
			wp_enqueue_style('car-demon-qualify-us-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-qualify.css', array(), CAR_DEMON_VER);
		}
	} else {
		wp_enqueue_style('car-demon-qualify-us-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-qualify.css', array(), CAR_DEMON_VER);
	}
	...
	if (!empty($popup_id)) {
		...
		if (isset($car_demon_options['use_form_css'])) {
			if ($car_demon_options['use_form_css'] != 'No') {
				wp_enqueue_style('car-demon-qualify-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-qualify-popup.css', array(), CAR_DEMON_VER);
			}
		} else {
			wp_enqueue_style('car-demon-qualify-popup-css', plugins_url() . '/car-demon/car-demon-forms/forms/css/car-demon-qualify-popup.css', array(), CAR_DEMON_VER);
		}
	...
	$x = apply_filters('cd_form_filter', $x, 'qualify', '');
	$x = apply_filters('car_demon_mail_hook_form', $x, 'qualify', 'unk'); //= deprecated
	$x .='
