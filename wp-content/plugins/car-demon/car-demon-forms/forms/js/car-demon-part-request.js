...
function car_demon_validate_part_request(form_id) {
	...
	var html = '<img src="' + cdPartsParams.spinner + '" /> ' + cdPartsParams.sending_msg;
	...
	if (msg != "") {
		...
		var send_data = {action: 'cd_parts_handler', 'nonce': nonce, 'your_name': your_name, 'phone':phone, 'email':email, 'part_location':part_location,'year':year, 'make':make, 'model':model, 'vin':vin, 'part_needed':part_needed, 'number_of_parts':number_of_parts, 'part_list':str};

		eval(cdPartsParams.form_data);
