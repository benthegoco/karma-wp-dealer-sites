...
function car_demon_validate(form_id) {
	...
	var html = '<img src="' + cdContactParams.spinner + '" /> ' + cdContactParams.sending_msg;
	...
	if (msg != "") {
		...
		var send_data = {action: 'cd_contact_us_handler', 'nonce': nonce, 'your_name': your_name, 'phone':phone, 'email':email, 'send_to':send_to, 'send_to_name':send_to_name, 'contact_needed':contact_needed};
		
		eval(cdContactParams.form_data);
