...
function car_demon_search_cars() {
	...
	if ($_POST['_name'] == 'search_condition') {
		...
		$str_tax_sql = 'SELECT DISTINCT '.$prefix.'terms_1.name AS new_name
			...
			WHERE ('. $condition_srch .' (('.$prefix.'term_taxonomy_1.taxonomy)="vehicle_year") AND (('.$prefix.'postmeta.meta_key)="sold") AND (('.$prefix.'postmeta.meta_value)="'. __( 'No', 'car-demon' ) . '"))
			ORDER BY new_name';
	...
	if ($_POST['_name'] == 'search_year') {
		...
		$str_tax_sql = 'SELECT DISTINCT '.$prefix.'terms_1.name AS new_name
			...
			LEFT JOIN ('.$prefix.'terms RIGHT JOIN '.$prefix.'term_taxonomy ON '.$prefix.'terms.term_id = '.$prefix.'term_taxonomy.term_id) ON '.$prefix.'term_relationships.term_taxonomy_id = '.$prefix.'term_taxonomy.term_taxonomy_id) ON '.$prefix.'term_relationships_1.object_id = '.$prefix.'term_relationships.object_id) 
			LEFT JOIN '.$prefix.'term_taxonomy AS '.$prefix.'term_taxonomy_1 ON '.$prefix.'term_relationships_1.term_taxonomy_id = '.$prefix.'term_taxonomy_1.term_taxonomy_id) LEFT JOIN '.$prefix.'terms AS '.$prefix.'terms_1 ON '.$prefix.'term_taxonomy_1.term_id = '.$prefix.'terms_1.term_id) ON '.$prefix.'postmeta.post_id = '.$prefix.'term_relationships_1.object_id
			WHERE ('. $year_srch .' (('.$prefix.'term_taxonomy_1.taxonomy)="vehicle_make") AND (('.$prefix.'postmeta.meta_key)="sold") AND (('.$prefix.'postmeta.meta_value)="' . __( 'No', 'car-demon' ) . '"))
			ORDER BY new_name';
		$my_results = $wpdb->get_results($str_tax_sql);
		$cnt_results = 0;
	...
	elseif ($_POST['_name'] == 'search_year_model') {
		...
		$str_tax_sql = 'SELECT DISTINCT '.$prefix.'terms_1.name AS new_name
			...
			LEFT JOIN ('.$prefix.'terms RIGHT JOIN '.$prefix.'term_taxonomy ON '.$prefix.'terms.term_id = '.$prefix.'term_taxonomy.term_id) ON '.$prefix.'term_relationships.term_taxonomy_id = '.$prefix.'term_taxonomy.term_taxonomy_id) ON '.$prefix.'term_relationships_1.object_id = '.$prefix.'term_relationships.object_id) 
			LEFT JOIN '.$prefix.'term_taxonomy AS '.$prefix.'term_taxonomy_1 ON '.$prefix.'term_relationships_1.term_taxonomy_id = '.$prefix.'term_taxonomy_1.term_taxonomy_id) LEFT JOIN '.$prefix.'terms AS '.$prefix.'terms_1 ON '.$prefix.'term_taxonomy_1.term_id = '.$prefix.'terms_1.term_id) ON '.$prefix.'postmeta.post_id = '.$prefix.'term_relationships_1.object_id
			WHERE ('. $year_srch .' (('.$prefix.'term_taxonomy_1.taxonomy)="vehicle_model") AND (('.$prefix.'postmeta.meta_key)="sold") AND (('.$prefix.'postmeta.meta_value)="' . __( 'No', 'car-demon' ) . '"))
			ORDER BY new_name';
		$my_results = $wpdb->get_results($str_tax_sql);
		$cnt_results = 0;
	...
	elseif ($_POST['_name'] == 'search_make') {
		...
		$str_tax_sql = 'SELECT DISTINCT '.$prefix.'terms_1.name AS new_name
			...
			LEFT JOIN ('.$prefix.'terms RIGHT JOIN '.$prefix.'term_taxonomy ON '.$prefix.'terms.term_id = '.$prefix.'term_taxonomy.term_id) ON '.$prefix.'term_relationships.term_taxonomy_id = '.$prefix.'term_taxonomy.term_taxonomy_id) ON '.$prefix.'term_relationships_1.object_id = '.$prefix.'term_relationships.object_id) 
			LEFT JOIN '.$prefix.'term_taxonomy AS '.$prefix.'term_taxonomy_1 ON '.$prefix.'term_relationships_1.term_taxonomy_id = '.$prefix.'term_taxonomy_1.term_taxonomy_id) LEFT JOIN '.$prefix.'terms AS '.$prefix.'terms_1 ON '.$prefix.'term_taxonomy_1.term_id = '.$prefix.'terms_1.term_id) ON '.$prefix.'postmeta.post_id = '.$prefix.'term_relationships_1.object_id
			WHERE ('.$make_str.' (('.$prefix.'term_taxonomy_1.taxonomy)="vehicle_model") AND (('.$prefix.'postmeta.meta_key)="sold") AND (('.$prefix.'postmeta.meta_value)="' . __( 'No', 'car-demon' ) . '"))
			ORDER BY new_name';
		$my_results = $wpdb->get_results($str_tax_sql);
		$cnt_results = 0;
		if (!empty($my_results)) {
	...
	elseif ($_POST['_name'] == 'search_make_condition') {
		...
		$str_tax_sql = 'SELECT DISTINCT '.$prefix.'terms_1.name AS new_name
			...
			LEFT JOIN ('.$prefix.'terms RIGHT JOIN '.$prefix.'term_taxonomy ON '.$prefix.'terms.term_id = '.$prefix.'term_taxonomy.term_id) ON '.$prefix.'term_relationships.term_taxonomy_id = '.$prefix.'term_taxonomy.term_taxonomy_id) ON '.$prefix.'term_relationships_1.object_id = '.$prefix.'term_relationships.object_id) 
			LEFT JOIN '.$prefix.'term_taxonomy AS '.$prefix.'term_taxonomy_1 ON '.$prefix.'term_relationships_1.term_taxonomy_id = '.$prefix.'term_taxonomy_1.term_taxonomy_id) LEFT JOIN '.$prefix.'terms AS '.$prefix.'terms_1 ON '.$prefix.'term_taxonomy_1.term_id = '.$prefix.'terms_1.term_id) ON '.$prefix.'postmeta.post_id = '.$prefix.'term_relationships_1.object_id
			WHERE ('. $condition_srch .' (('.$prefix.'term_taxonomy_1.taxonomy)="vehicle_make") AND (('.$prefix.'postmeta.meta_key)="sold") AND (('.$prefix.'postmeta.meta_value)="' . __( 'No', 'car-demon' ) . '"))
			ORDER BY new_name';
		$my_results = $wpdb->get_results($str_tax_sql);
		$cnt_results = 0;
		$array[] = array('' => 'ALL MAKES');
	...
	elseif ($_POST['_name'] == 'search_model_condition') {
		...
		$str_tax_sql = 'SELECT DISTINCT '.$prefix.'terms_1.name AS new_name
			...
			LEFT JOIN ('.$prefix.'terms RIGHT JOIN '.$prefix.'term_taxonomy ON '.$prefix.'terms.term_id = '.$prefix.'term_taxonomy.term_id) ON '.$prefix.'term_relationships.term_taxonomy_id = '.$prefix.'term_taxonomy.term_taxonomy_id) ON '.$prefix.'term_relationships_1.object_id = '.$prefix.'term_relationships.object_id) 
			LEFT JOIN '.$prefix.'term_taxonomy AS '.$prefix.'term_taxonomy_1 ON '.$prefix.'term_relationships_1.term_taxonomy_id = '.$prefix.'term_taxonomy_1.term_taxonomy_id) LEFT JOIN '.$prefix.'terms AS '.$prefix.'terms_1 ON '.$prefix.'term_taxonomy_1.term_id = '.$prefix.'terms_1.term_id) ON '.$prefix.'postmeta.post_id = '.$prefix.'term_relationships_1.object_id
			WHERE ('. $condition_srch .' (('.$prefix.'term_taxonomy_1.taxonomy)="vehicle_model") AND (('.$prefix.'postmeta.meta_key)="sold") AND (('.$prefix.'postmeta.meta_value)="' . __( 'No', 'car-demon' ) . '"))
			ORDER BY new_name';
		$my_results = $wpdb->get_results($str_tax_sql);
		$cnt_results = 0;
		$array[] = array('' => 'ALL MODELS');
	...
	if ($type == 1 ) {
		if (!empty($old_val)) {
			...
			$str_sql = 'SELECT Count('.$prefix.'terms.slug) AS new_name
					...
					AND (('.$prefix.'postmeta.meta_value)="' . __( 'No', 'car-demon' ) . ' "))';
		}
		else {
	...
	if ($type == 2 ) {
		...
		if (empty($old_val)) {
			...
			$str_sql = 'SELECT Count('.$prefix.'terms.slug) AS new_name
				...
				WHERE ((('.$prefix.'terms.name)="'. $new_val .'") AND (('.$prefix.'term_taxonomy.taxonomy)="vehicle_model") AND (('.$prefix.'postmeta.meta_key)="sold ") AND (('.$prefix.'postmeta.meta_value)="' . __( 'No', 'car-demon' ) . ' "))';
		}
	}
	if ($type == 3 ) {
		if (!empty($old_val)) {
