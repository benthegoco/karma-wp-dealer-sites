...
function car_demon_validate() {
	...
	var html = '<img src="' + cdContactWidgetParams.spinner + '" /> ' + cdContactWidgetParams.sending_msg;
	...
	/*
	Please no eval() lectures please
	*/
	eval(cdContactWidgetParams.form_js);
...
function ValidatePhone(object){
  ...
  if(cursorposition >= 0){
	...
	if (typeof(object.createTextRange) == 'function') {
