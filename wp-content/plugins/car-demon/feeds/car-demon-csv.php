...
function build_csv() {
	...
	foreach ($total_cars as $total_car) {
		...
		$location = trim(get_cd_term( $post_id, 'vehicle_location' ));
		...
		$car_csv .= '"'.trim(get_cd_term( $post_id, 'vehicle_year' ));
		$car_csv .= '"'.trim(get_cd_term( $post_id, 'vehicle_make' ));
		$car_csv .= '"'.trim(get_cd_term( $post_id, 'vehicle_model' ));
		...
		$car_csv .= '"'.trim(get_cd_term( $post_id, 'vehicle_body_style' ));
		$car_csv .= '"'.trim(get_cd_term( $post_id, 'vehicle_condition' ));
		$car_csv .= '"",';
//	PRICE
...
//		$options = $option_array;
		...
		$car_pic_list .= '@@';
		$car_pic_list = str_replace(',@@','',$car_pic_list);
		$car_pic_list = str_replace('@@','',$car_pic_list);
		
		/* - Add linked photos to feed
