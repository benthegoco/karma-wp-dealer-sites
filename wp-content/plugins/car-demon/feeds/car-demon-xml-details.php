...
function build_xml() {
	$post_id = $_GET['post_id'];
		...
		$car_xml .= rwh_xml(trim(get_cd_term( $post_id, 'vehicle_year' )),'year');
		$car_xml .= rwh_xml(trim(get_cd_term( $post_id, 'vehicle_make' )),'make');
		$car_xml .= rwh_xml(trim(get_cd_term( $post_id, 'vehicle_model' )),'model');
		$car_xml .= rwh_xml(trim(get_cd_term( $post_id, 'vehicle_condition' )),'condition');
		$car_xml .= rwh_xml(trim(get_cd_term( $post_id, 'vehicle_body_style' )),'body_style');
		$car_xml .= rwh_xml(trim(get_cd_term( $post_id, 'vehicle_location' )),'location');
