	...
	if ( "ID" == $column ) {
		...
		echo '<div id="show_sold_' . $post_id . '">
				<select id="is_sold_' . $post_id . '" onchange="update_car_sold(' . $post_id . ', this, \'sold\')">
					<option value="'. __( 'No', 'car-demon' ) .'"' . ($sold == __( 'No', 'car-demon' ) || $sold == 'no' ? ' selected' : '' ) . '>' . __( 'No', 'car-demon' ) . '</option>
					<option value="'. __( 'Yes', 'car-demon' ) .'"' . ($sold == __( 'Yes', 'car-demon' ) ? ' selected' : '' ) . '>' . __( 'Yes', 'car-demon' ) . '</option>
				</select>
			</div>';
	}
}
