<?php
require_once( 'cd-nag.php' );
require_once( 'welcome.php' );
require_once( 'readme.php' );
require_once( 'cd-settings.php' );
require_once( 'location-settings.php' );
require_once( 'columns.php' );
require_once( 'cell-providers.php' );
require_once( 'build-pages.php' );
require_once( 'cd-insert-samples.php' );
require_once( 'tabs-admin.php' );
require_once( 'cd-meta-boxes.php' );
/**
 * Function to run when cars_for_sale post type is saved
 * @todo
 *     - Document functions
 */
require_once( 'cd-save.php' );
...
function car_demon_admin_scripts() {
	...
	wp_register_script( 'cd-upload', '/wp-content/plugins/car-demon/theme-files/js/uploader.js', array( 'jquery','media-upload','thickbox' ), CAR_DEMON_VER );
