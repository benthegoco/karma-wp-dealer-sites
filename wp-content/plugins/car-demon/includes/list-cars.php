...
function car_demon_dynamic_ribbon_filter( $current_ribbon, $post_id, $size ) {
	...
	$current_ribbon = apply_filters( 'cd_ribbon_filter', $current_ribbon, $post_id, $size );
	$current_ribbon = apply_filters( 'car_demon_dynamic_ribbon_hook', $current_ribbon, $post_id, $size ); //= deprecated
