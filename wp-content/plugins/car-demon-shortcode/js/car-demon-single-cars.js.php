...
$cdsp_theme_path = str_replace('js','',$cdsp_theme_path);
$body_count = 50;
$body_width = ($body_count*125)-125;
$fake_width = 294;
$script = '
	var IMG_WIDTH = 125;
	var currentImg=0;
	...
	*/
	...
	function popup_car(data) {
		...
		body = body + \'<link rel="stylesheet" href="'.plugins_url().'/car-demon-shortcode/css/print.css" type="text/css" media="print">\';
		body = body + \'<link rel="stylesheet" href="'.plugins_url().'/car-demon-shortcode/css/cdf.css" type="text/css" media="all">\';
		body = body + \'<link rel="stylesheet" href="'.plugins_url().'/car-demon-shortcode/css/car-demon-theme' . CDS_CSS_VER . '.css" type="text/css" media="all">\';
		body = body + \'<link rel="stylesheet" href="'.plugins_url().'/car-demon-shortcode/css/single-cars-for-sale.css" type="text/css" media="all">\';
		body = body + \'<style>\';
