<?php
function cdsp_template_2($post_id) {
	$template = get_car_template($post_id);
   	$x = '
        <div class="car_item_pro cd_2">
            ...
            <div class="description">
					...
					<div class="description_wrap">';
						if ($template['show_hide']['vin'] != true) {
							$x .= '<div class="description_label vin">'.$template['labels']['vin'].':</div>';
							$x .= '<div class="description_text_vin">'.$template['car']['vin'].'</div>';
						}
                    $x .= '</div>
