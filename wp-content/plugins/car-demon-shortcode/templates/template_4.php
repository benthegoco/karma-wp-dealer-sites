<?php
function cdsp_template_4($post_id) {
	$template = get_car_template($post_id);
   	$x = '
        <div class="car_item_pro cd_4">
            ...
            <div class="description">
                ...
                <div class="description_right">';
					...
					if ($template['show_hide']['vin'] != true) {
						$x .= '<div class="description_label">'.$template['labels']['vin'].':</div>';
						$x .= '<div class="description_text">'.$template['car']['vin'].'</div>';
					}
                $x .= '</div>
